  ...
  return (
    <header className="sticky top-0 right-0 left-0 h-[72px] bg-white border-b border-[#E5E9F0] flex items-center justify-between px-8 z-20">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* User Card matching Alex Rivera */}
        <button 
        ...
        >
          <img 
            src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=96&h=96&fit=crop&q=80" 
            alt="Alex Rivera" 
            className="w-8 h-8 rounded-lg object-cover"
          />
          <div>
            <span className="block text-xs font-bold text-[#111827] leading-tight">Alex Rivera</span>
            <span className="block text-[10px] text-[#6B7280] font-semibold mt-0.5">Senior Frontend Dev</span>
          </div>
        </button>
      </div>
